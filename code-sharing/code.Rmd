...
First divide the data into training set (01-Oct-2019 to 30-Nov-2019) and test set (01-Dec-2019 to 31-Dec-2019). We use the training set to train the model. We remove all any technical anomalies we identified as the model needs to be trained on a cleaned dataset. 
