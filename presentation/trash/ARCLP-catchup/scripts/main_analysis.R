...
source(here::here("ARCLP-DES-Catchup", "Meeting-4",
                  "scripts", "SPOT_algorithm.R"))

## loadPRINData
load(here::here("ARCLP-DES-Catchup", "Meeting-4", "data", "data_lagged_upstream.rda"))
load(here::here("ARCLP-DES-Catchup", "Meeting-4", "data", "data_downstream_imputed.rda"))

load(here::here("ARCLP-DES-Catchup", "Meeting-4", "data", "PRIN_5min_flagged.rda"))
